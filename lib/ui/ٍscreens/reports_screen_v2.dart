...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Reports & Invoices')),
      body: Padding(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                ElevatedButton(onPressed: _loadInvoices, child: const Text('Reload')),
              ],
            ),
            const SizedBox(height: 12),
            // Summary cards
                  ...
                  child: Card(
                    child: Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Text('Invoices Today'),
                          const SizedBox(height: 8),
                          Text('${invoices.length}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 8),
                          Text('${totalForDay.toStringAsFixed(2)} EGP', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ),
                  ),
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return Card(
                          child: ListTile(
                            ...
                            trailing: Text('${inv['total']} EGP', style: const TextStyle(fontWeight: FontWeight.bold)),
